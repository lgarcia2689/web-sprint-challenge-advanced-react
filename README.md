...
Cleaner code, that is easy to follow and change, while also allowing reusability.

2. When does a componentWillMount function be called? What about a componentWillUpdate?
It is invoked immediately  before mounting occurs, componentWillUpdate method is invoked right before rendering

3. Define stateful logic.
it is code that uses state, in jooks it is defines as a behavior created with the use of a hook
